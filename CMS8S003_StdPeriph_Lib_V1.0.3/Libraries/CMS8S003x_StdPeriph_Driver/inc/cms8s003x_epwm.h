...
/*
typedef struct EPWM_Prescaler
{
	Prescaler_TypeDef EPWM0_Prescaler; 
	Prescaler_TypeDef EPWM1_Prescaler;
	Prescaler_TypeDef EPWM2_Prescaler;
	Prescaler_TypeDef EPWM3_Prescaler;
	Prescaler_TypeDef EPWM4_Prescaler;
	Prescaler_TypeDef EPWM5_Prescaler;
} EPWM_Prescaler_TypeDef;*/
/*
typedef enum
{
	EPWM0_DataReload			= ((uint8_t)0x01),
	EPWM1_DataReload			= ((uint8_t)0x02),
	EPWM2_DataReload			= ((uint8_t)0x04),
	EPWM3_DataReload			= ((uint8_t)0x08),
	EPWM4_DataReload			= ((uint8_t)0x10),
	EPWM5_DataReload			= ((uint8_t)0x20),
	EPWMAll_DataReload		= ((uint8_t)0xFF),
} EPWM_DataReload_Typedef;*/
...
typedef enum
{
	EPWM0_OP        	= ((uint8_t)0x01),
	EPWM1_OP					= ((uint8_t)0x02),
	EPWM2_OP					= ((uint8_t)0x04),
	EPWM3_OP					= ((uint8_t)0x08),
	EPWM4_OP					= ((uint8_t)0x10),
	EPWM5_OP					= ((uint8_t)0x20),
	EPWMAll_OP				= ((uint8_t)0xFF),
} EPWM_OP_Inverted_TypeDef;*/
...
typedef enum
{
	EPWM0_CounterMode        	=  ((uint8_t)0x01),
	EPWM1_CounterMode 				=  ((uint8_t)0x02),
	EPWM2_CounterMode 				=  ((uint8_t)0x04),
	EPWM3_CounterMode 				=  ((uint8_t)0x08),
	EPWM4_CounterMode 				=  ((uint8_t)0x10),
	EPWM5_CounterMode					=  ((uint8_t)0x20),
	EPWM_All_CounterMode 			=  ((uint8_t)0xFF),
} EPWM_CounterMode_Repetitive_TypeDef;*/
typedef EPWM_Channel_TypeDef  EPWM_CounterMode_Repetitive_TypeDef;
/*
typedef enum 
{
	EPWM0_ENABLE 		= ((uint8_t)0x01),
	EPWM1_ENABLE 		= ((uint8_t)0x02),
	EPWM2_ENABLE 		= ((uint8_t)0x04),
	EPWM3_ENABLE 		= ((uint8_t)0x08),
	EPWM4_ENABLE 		= ((uint8_t)0x10),
	EPWM5_ENABLE 		= ((uint8_t)0x20),
	EPWM_All_ENABLE = ((uint8_t)0xFF)
} EPWM_ENABLE_TypeDef; 

typedef enum 
{
	EPWM0_CouterZero 		= ((uint8_t)0x01),
	EPWM1_CouterZero 		= ((uint8_t)0x02),
	EPWM2_CouterZero 		= ((uint8_t)0x04),
	EPWM3_CouterZero 		= ((uint8_t)0x08),
	EPWM4_CouterZero 		= ((uint8_t)0x10),
	EPWM5_CouterZero 		= ((uint8_t)0x20),
	EPWM_All_CouterZero = ((uint8_t)0xFF)
} EPWM_CouterZero_TypeDef;
*/
...
/*
typedef struct EPWM_MaskDataBit_Def
{
	uint8_t 	EPWM0_MASKDataBit:1;
	uint8_t 	EPWM1_MASKDataBit:1;
	uint8_t 	EPWM2_MASKDataBit:1;
	uint8_t 	EPWM3_MASKDataBit:1;
	uint8_t 	EPWM4_MASKDataBit:1;
	uint8_t 	EPWM5_MASKDataBit:1;
	uint8_t 	EPWMAll_MASKDataBit:1;
} EPWM_MaskDateBit_TypeDef;*/
...
/*
typedef struct EPWM_Brake_Output_Def
{
  Brake_Output_TypeDef   Brake_PWM0:1;
	Brake_Output_TypeDef   Brake_PWM1:1;
	Brake_Output_TypeDef   Brake_PWM2:1;
	Brake_Output_TypeDef   Brake_PWM3:1;
	Brake_Output_TypeDef   Brake_PWM4:1;
	Brake_Output_TypeDef   Brake_PWM5:1;
	Brake_Output_TypeDef   Brake_PWMAll:1;
} EPWM_Brake_Output_TypeDef;*/
